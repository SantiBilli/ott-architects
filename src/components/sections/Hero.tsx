      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="opacity-0 animate-fade-in-up animate-delay-100 font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
            Transformamos tu <span className="gradient-text">plataforma de streaming</span> en una
            experiencia premium
          </h1>
          ...
          <p className="opacity-0 animate-fade-in-up animate-delay-200 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Consultora especializada en arquitectura OTT y transformación digital. Modernizamos
            plataformas de streaming con tecnología de última generación.
          </p>
          ...
          {/* Stats */}
          <div className="opacity-0 flex flex-row gap-5 justify-center animate-fade-in-up animate-delay-400 mt-20">
            {[
